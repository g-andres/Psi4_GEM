...
namespace libint2 {
  ...
  class BasisSet : public std::vector<libint2::Shell> {
    public:
       ...
       *         <li> hardwired to directory \c /psi/gits/libint2/build45/export/share/libint/2.7.0-beta.6/basis </li>
       *       </ol>
       */
...
#else
          path = std::string("/psi/gits/libint2/build45/export/share/libint/2.7.0-beta.6");
#endif
        }
